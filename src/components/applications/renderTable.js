      ...
      ${applications.map(app => `
        <div class="card group ${tableRow} ${tableCols}">
          ...
          <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100">
            ...
            <button
              data-edit="${app.id}"
              class="transition-colors duration-200 hover:text-orange-500 dark:hover:text-yellow-500 focus:outline-none"
            >
            ...
            <!-- DELETE BUTTON -->
            <button
              class="transition-colors duration-200 hover:text-red-500 focus:outline-none"
              data-delete="${app.id}"
            >
              <svg xmlns="http://www.w3.org/2000/svg"
                fill="none"
